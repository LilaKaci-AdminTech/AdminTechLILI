...
* **Secrétaire Administrative (2024 - 2025) :** Gestion complète du secrétariat, facturation, suivi des dossiers d'inscription au permis et gestion des plannings via les outils numériques.
...
* *Compétences clés :* Gestion documentaire, techniques d'archivage, classement, gestion de bases de données.
